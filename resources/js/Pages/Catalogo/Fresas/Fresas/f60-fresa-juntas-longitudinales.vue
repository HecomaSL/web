<script setup>
    ...
    const tablaAgrupada = computed(() => {
        ...
        props.productos.forEach(prod => {
            ...
            // Regex específica para F60: Familia-Diámetro(3)P(Paso)(Material)
            // Ejemplo: "F60-140P4M" -> D: 140, Paso: 4, Mat: M
            ...
            if (match) {
                ...
                // La base para agrupar es la referencia sin el material final (M o H)
                ...
                if (!grupos[baseRef]) {
                    grupos[baseRef] = {
                        medidas: {
                            D: diametro,
                            B: (parseInt(pasoValor) * 10), // Según imagen: Paso 4 -> B 40
                            d: '50',
                            Z: '4',
                            paso: pasoValor
                        },
        ...
        return Object.values(grupos).sort((a, b) => {
            return a.medidas.D - b.medidas.D || a.medidas.paso - b.medidas.paso;
        });
    });
