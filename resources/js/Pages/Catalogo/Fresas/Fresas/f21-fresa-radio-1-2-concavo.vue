<script setup>
    ...
    const tablaAgrupada = computed(() => {
        ...
        props.productos.forEach(prod => {
          const match = prod.referencia.match(/F21-(\d{3})R(\d{2,3})(M|H)/);
          ...
          if (match) {
            ...
            if (!grupos[baseRef]) {
              const rMap = { 4:  18, 5: 20, 6: 22, 8: 28, 10: 32, 12: 36, 15: 44, 20: 55 };
  ...
  <MainLayout>
    <section class="bg-[#010cf7] py-6 mb-12">
      <div class="container mx-auto px-6">
        <h1 class="text-white text-3xl md:text-4xl font-bold text-center uppercase tracking-wide">F21 Fresa radio 1/2 cóncavo</h1>
      </div>
    </section>
    ...
    <section class="container mx-auto px-6 mb-16">
      <div class="max-w-6xl mx-auto space-y-6 text-gray-700 leading-relaxed text-lg">
        <h2 class="text-[#010cf7] text-3xl font-bold mb-6">Características de nuestra fresa para radio concavo 1/2:</h2>
        ...
        <p>Fresa para mecanizar radios completos. El cuerpo de la herramienta está fabricado en aleación de acero de alta resistencia. Las placas de metal duro (carburo de tungsteno) son soldadas mediante aleación trimetálica. Con estos materiales y una fabricación mediante CNC de alta precisión, obtenemos gran rendimiento, estabilidad en la calidad del corte y una gran duración de la herramienta.  La fresa se sirve con las indicaciones de uso necesarias para el correcto desempeño de esta.</p>
        ...
        <p class="link"><a href="https://hecoma.com/wp-content/uploads/2021/03/F20a-esquema-radiosR.pdf">–> Descarga documento pdf esquema de radios a escala 1:1  <–</a></p>
      </div>
    </section>
