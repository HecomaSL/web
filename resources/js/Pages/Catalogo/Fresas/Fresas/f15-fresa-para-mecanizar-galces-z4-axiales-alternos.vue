<script setup>
    ...
    const tablaAgrupada = computed(() => {
        ...
        props.productos.forEach(prod => {
          const match = prod.referencia.match(/F15-(\d{3})(\d{2,3})/);
          if (match) {
  ...
  <MainLayout>
    <section class="bg-[#010cf7] py-6 mb-5">
      <div class="container mx-auto px-6">
        <h1 class="text-white text-3xl md:text-4xl font-bold text-center uppercase tracking-wide">F15 Fresa para Galces Z4 (Cortes Alternos)</h1>
      </div>
    </section>
    ...
    <section class="container mx-auto px-6 mb-10">
      <div class="max-w-6xl mx-auto space-y-6 text-gray-700 leading-relaxed text-lg">
        <h2 class="text-[#010cf7] text-3xl font-bold mb-6">Características de nuestra fresa para galces axiales alternos:</h2>
        <ul class="list-disc list-inside space-y-2 ml-4 text-[#010cf7] font-medium">
          <li><span class="text-gray-700 font-normal">4 cortes axiales alternos (Z),  para trabajar con menores vibraciones, con mejor acabado y avance</span></li>
          <li><span class="text-gray-700 font-normal">Fabricado en MD (carburo de tungsteno) para materiales duros o medios, y HSS (aleaciones de acero endurecido) para maderas blandas</span></li>
        ...
        <p>Herramienta para labrar galces y cantos en cualquier tipo de madera, proporciona mejor avance y trabaja con menos vibraciones que la referencia F14. El cuerpo se fabrica en aleación de acero especial, duradero y con mejor absorción de vibraciones. Las placas de corte (en carburo de tungsteno) son soldadas mediante aleación trimetálica.  Utilizamos los mejores materiales y  CNC de alta precisión,  para obtener gran rendimiento, estabilidad en la calidad del corte y gran duración del filo.  La fresa se entrega con las instrucciones de uso necesarias para el correcto trabajo de esta.</p>
        <p>Esta fresa forma parte de la serie de herramientas profesionales exprés (ProEx). Está disponible en las medidas indicadas en la tabla en nuestros distribuidores de material de ferretería y carpintería.</p>
