    ...
    <MainLayout>
        <section class="bg-[#010cf7] py-6 mb-12">
            <div class="container mx-auto px-6">
                <h1 class="text-white text-3xl md:text-4xl font-bold text-center uppercase tracking-wide">F10 Fresa para ranurar Z4</h1>
            </div>
        </section>
        ...
        <section class="container mx-auto px-6 mb-16">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                <div class="overflow-hidden shadow-md">
                    <img src="images/fresas/f10.jpg" alt="Fresa para ranurar Z4" style="width: 100%;" />
                </div>
                <div class="space-y-4 text-gray-700 text-justify">
                    <p>Nuestra fresa para ranurar Z4 se consolida como la herramienta de alta ingeniería para el mecanizado industrial de madera a favor de fibra. Configurada con 4 cortes rectos (Z4) de alto rendimiento, esta fresa para ranurado está diseñada para ofrecer una estabilidad dinámica excepcional, eliminando vibraciones y garantizando una geometría de ranura perfecta en cada pasada.</p>
                    <p>Para optimizar el ciclo de vida de la herramienta según el material, HECOMA® ofrece esta serie en dos configuraciones críticas: Metal Duro (HM), para una resistencia máxima en maderas duras y tableros abrasivos, y Acero Rápido (HSS), para lograr una limpieza de corte superior en maderas blandas y resinosas.</p>
                    <p>Desarrollada específicamente para maquinaria con avance mecánico, nuestra fresa para ranurado permite velocidades de trabajo constantes y una evacuación de viruta optimizada, convirtiéndose en la solución técnica indispensable para procesos que exigen precisión dimensional, un acabado libre de marcas y un rendimiento operativo de largo alcance en líneas de producción continua.</p>
                </div>
            </div>
        </section>
        ...
        <section class="container mx-auto px-6 mb-16">
            <div class="max-w-6xl mx-auto space-y-6 text-gray-700 leading-relaxed text-lg">
                ...
                <ul class="list-disc list-inside space-y-2 ml-4  font-medium">
                    <li><span class="text-gray-700 font-normal">Fresa para ranurar con 4 cortes rectos (Z4).</span></li>
