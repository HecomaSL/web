...
function parseRef(ref) {
  const match = ref.match(/^D(\d{3})(\d{2})(\d{2})Z(\d{2,3})PTS$/)
  ...
  <MainLayout>
    <section class="bg-[#010cf7] py-6 mb-12">
      <div class="container mx-auto px-6">
        <h1 class="text-white text-3xl md:text-4xl font-bold text-center uppercase tracking-wide">Serie 11.4 Discos silenciados para aluminio.</h1>
      </div>
    </section>
    ...
    <section class="container mx-auto px-6 mb-16">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        ...
        <div class="space-y-4 text-gray-700">
          <p>Diseñada para la excelencia en el mecanizado de metales no férreos, la Serie 11.4 se posiciona como la solución técnica avanzada en discos silenciosos para aluminio, perfiles de pared delgada y chapas.</p>
          <p>Esta serie integra la tecnología de absorción acústica de HECOMA®, específicamente calibrada para neutralizar las resonancias de alta frecuencia propias del corte de metales, transformando un proceso tradicionalmente ruidoso en un mecanizado estable y confortable.</p>
          <p>Gracias a su configuración optimizada, estos discos garantizan una evacuación de viruta ultraeficiente, evitando el embotamiento y asegurando un acabado superficial espejo sin rebabas en aleaciones ligeras.</p>
          <p>Su estructura reforzada minimiza las vibraciones laterales, lo que se traduce en una precisión dimensional absoluta y una mayor vida útil del metal duro, incluso en ritmos de producción intensiva.</p>
        </div>
      </div>
      <div class="max-w-6xl mx-auto space-y-6 text-gray-700 leading-relaxed text-lg">
        <p>Es la herramienta de corte definitiva para carpinterías metálicas e industrias auxiliares que demandan un entorno de trabajo saludable sin comprometer la limpieza y la exactitud en cada sección.</p>
      </div>
    </section>
    <section class="container mx-auto px-6 mb-16">
      <div class="max-w-6xl mx-auto space-y-6 text-gray-700 leading-relaxed text-lg">
