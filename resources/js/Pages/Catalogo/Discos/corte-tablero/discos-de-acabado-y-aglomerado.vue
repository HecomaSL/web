    ...
    <section class="container mx-auto px-6 mb-10">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        ...
        <div class="space-y-4 text-gray-700">
          ...
          <p>Estos discos son la herramienta ideal para trabajar con madera, MDF, melamina y tablero aglomerado, permitiendo eliminar imperfecciones e igualar la pieza con total precisión.</p>
          <p>Gracias al diseño de HECOMA®, esta serie garantiza un acabado uniforme y profesional, dejando la superficie lista para procesos posteriores de pintura, barnizado o lacado. Son la solución perfecta para la fabricación de muebles donde la estética y la suavidad del material son fundamentales.</p>
          <p>Los discos de acabado y aglomerado son abrasivos ideales para el lijado y preparación de superficies en madera, MDF, melamina y tablero aglomerado.</p>
        </div>
      </div>
      <div class="max-w-6xl mx-auto space-y-6 text-gray-700 leading-relaxed ">
        <p>Se usan para eliminar imperfecciones, igualar la pieza y dejar un acabado uniforme, listo para pintar, barnizar o lacar. Perfectos para carpintería y fabricación de muebles, ofrecen buen rendimiento, control y un acabado profesional.</p>
