    ...
    <section class="container mx-auto px-6 mb-16">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        <div class="overflow-hidden shadow-md">
          <img src="/images/brocas/brocasMDI/b21.png" alt="" style="width: 20%;" />
        </div>
        <div class="space-y-4 text-gray-700">
          ...
          <ul class="list-disc list-inside space-y-2 ml-4 text-[#010cf7] font-medium">
            ...
            <li><span class="text-gray-700 font-normal">Un solo filo de corte. Positiva</span></li>
          ...
          <ul class="list-disc list-inside space-y-2 ml-4 text-[#010cf7] font-medium">
            <li><span class="text-gray-700 font-normal">Para corte y fresado de aluminio</span></li>
