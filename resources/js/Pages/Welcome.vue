...
<template>
    ...
    <MainLayout>
        ...
        <section class="mt-5 w-full overflow-hidden">
            <div class="slider-container">
                <div class="slider" id="slider">
                    <ul class="slides">
                        ...
                        <li class="slide">
                            <a href="#"><img src="/images/SLIDER2.jpg" alt="SLIDER 2"></a>
                        </li>
                        <li class="slide">
                            <a href="#"><img src="/images/SLIDER3.jpg" alt="SLIDER 3"></a>
                        </li>
                        <li class="slide">
                            <a href="#"><img src="/images/SLIDER4.jpg" alt="SLIDER 4"></a>
                        </li>
                        <li class="slide">
                            <a href="#"><img src="/images/SLIDER1.jpg" alt="SLIDER 1"></a>
                        </li>
...
.sectionColor a { text-decoration: underline; font-weight: bold; }
