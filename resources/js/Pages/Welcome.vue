    ...
    <MainLayout>
        ...
        <section class="sectionColor bg-[#0000BB] text-white py-10 px-6">
            <div class="container mx-auto max-w-5xl text-center">
                ...
                <h1 class="text-3xl md:text-4xl font-bold mb-8 leading-tight uppercase tracking-wide">Fabricación de Herramientas de Corte para Madera de Alto Rendimiento (Prueba despliegue correcta)</h1>
