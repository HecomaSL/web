...
/**
 * Copia el texto al portapapeles y activa el feedback visual
 * @param {string} texto - El valor a copiar
 * @param {string} campo - El identificador del campo para el feedback
 */
                    ...
                    <div class="space-y-3 bg-white p-5 rounded-lg border border-blue-100 shadow-sm">
                        ...
                        <div class="flex justify-between items-center border-b border-gray-100 pb-2">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button @click="copiarAlPortapapeles(pedido?.total, 'precio')" class="btn-copy" title="Copiar Precio">
