...
<template>
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">Asegúrese de que su cuenta utilice una contraseña larga y aleatoria para mantenerla segura.</p>
        </header>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <Transition enter-active-class="transition ease-in-out" enter-from-class="opacity-0" leave-active-class="transition ease-in-out" leave-to-class="opacity-0" >
                    <p v-if="form.recentlySuccessful" class="text-sm text-gray-600" >Guardada correctamente.</p>
                </Transition>
            </div>
        </form>
    </section>
