  ...
  <MainLayout>
    ...
    <section class="max-w-6xl container mx-auto px-6 mb-16">
      <div class="max-w-6xl mx-auto space-y-6 text-gray-700 leading-relaxed text-lg">
        ...
        <p>Con el ánimo de que el uso del Sitio Web se ajuste a criterios de transparencia, claridad y sencillez, la EMPRESA informa al Usuario que cualquier sugerencia, duda o consulta sobre las Condiciones Generales de Uso será recibida y solucionada contactando con la EMPRESA a través del correo electrónico: <a href="mailto:rgpd@hecoma.com">rgpd@hecoma.com</a></p>
      </div>
    </section>
    ...
    <section class="container mx-auto px-6 mb-16 max-w-6xl">
      ...
      <div class="space-y-4 text-gray-700">
        ...
        <p>Por todo ello el Usuario se compromete a no reproducir, copiar, distribuir, poner a disposición o de cualquier otra forma comunicar públicamente, transformar o modificar tales contenidos manteniendo indemne a la EMPRESA de cualquier reclamación que se derive del incumplimiento de tales obligaciones.</p>
    ...
    <section class="container mx-auto px-6 mb-16 max-w-6xl">
      ...
      <div class="space-y-4 text-gray-700">
        ...
        <ul class="list-disc list-inside space-y-2 ml-4 text-[#010cf7] font-medium">
            <li><span class="text-gray-700 font-normal">Hacer un uso no autorizado o fraudulento del Sitio Web y/o de los contenidos con fines o efectos ilícitos, prohibidos en las presentes Condiciones Generales de Uso, lesivos de los derechos e intereses de terceros, o que de cualquier forma puedan dañar, inutilizar, sobrecargar, deteriorar o impedir la normal utilización de los servicios o los documentos, archivos y toda clase de contenidos almacenados en cualquier equipo informático.</span></li>
            <li><span class="text-gray-700 font-normal">Acceder o intentar acceder a recursos o áreas restringidas del Sitio Web, sin cumplir las condiciones exigidas para dicho acceso.</span></li>
            <li><span class="text-gray-700 font-normal">Provocar daños en los sistemas físicos o lógicos del Sitio Web, de sus proveedores o de terceros.</span></li>
            <li><span class="text-gray-700 font-normal">Introducir o difundir en la red virus informáticos o cualesquiera otros sistemas físicos o lógicos que sean susceptibles de provocar daños en los sistemas físicos o lógicos de la EMPRESA, de sus proveedores o de terceros.</span></li>
            <li><span class="text-gray-700 font-normal">Intentar acceder, utilizar y/o manipular los datos de la EMPRESA, terceros proveedores y otros Usuarios.</span></li>
            <li><span class="text-gray-700 font-normal">Reproducir o copiar, distribuir, permitir el acceso del público a través de cualquier modalidad de comunicación pública, transformar o modificar los contenidos, a menos que se cuente con la autorización del titular de los correspondientes derechos o ello resulte legalmente permitido</span></li>
            <li><span class="text-gray-700 font-normal">Suprimir, ocultar o manipular las notas sobre derechos de propiedad intelectual o industrial y demás datos identificativos de los derechos de la EMPRESA o de terceros incorporados a los contenidos, así como los dispositivos técnicos de protección o cualesquiera mecanismos de información que puedan insertarse en los contenidos.</span></li>
            <li><span class="text-gray-700 font-normal">Obtener e intentar obtener los contenidos empleando para ello medios o procedimientos distintos de los que, según los casos, se hayan puesto a su disposición a este efecto o se hayan indicado expresamente en las páginas web donde se encuentren los contenidos o, en general, de los que se empleen habitualmente en Internet por no entrañar un riesgo de daño o inutilización del sitio web y/o de los contenidos.</span></li>
            <li><span class="text-gray-700 font-normal">En particular, y a título meramente indicativo y no exhaustivo, el Usuario se compromete a no transmitir, difundir o poner a disposición de terceros informaciones, datos, contenidos, mensajes, gráficos, dibujos, archivos de sonido y/o imagen, fotografías, grabaciones, software y, en general, cualquier clase de material que:</span></li>
            <ul class="list-disc list-inside space-y-2 ml-4 text-[#010cf7] font-medium">
              <li><span class="text-gray-700 font-normal">De cualquier forma sea contrario, menosprecie o atente contra los derechos fundamentales y las libertades públicas reconocidas constitucionalmente, en los Tratados Internacionales y en el resto de la legislación vigente.</span></li>
              <li><span class="text-gray-700 font-normal">Induzca, incite o promueva actuaciones delictivas, denigratorias, difamatorias, violentas o, en general, contrarias a la ley, a la moral, a las buenas costumbres generalmente aceptadas o al orden público.</span></li>
              <li><span class="text-gray-700 font-normal">Induzca, incite o promueva actuaciones, actitudes o pensamientos discriminatorios por razón de sexo, raza, religión, creencias, edad o condición.</span></li>
              <li><span class="text-gray-700 font-normal">Incorpore, ponga a disposición o permita acceder a productos, elementos, mensajes y/o servicios delictivos, violentos, ofensivos, nocivos, degradantes o, en general, contrarios a la ley, a la moral y a las buenas costumbres generalmente aceptadas o al orden público.</span></li>
              <li><span class="text-gray-700 font-normal">Induzca o pueda inducir a un estado inaceptable de ansiedad o temor.</span></li>
              <li><span class="text-gray-700 font-normal">Induzca o incite a involucrarse en prácticas peligrosas, de riesgo o nocivas para la salud y el equilibrio psíquico.</span></li>
              <li><span class="text-gray-700 font-normal">Se encuentra protegido por la legislación en materia de protección intelectual o industrial perteneciente a la EMPRESA o a terceros sin que haya sido autorizado el uso que se pretenda realizar.</span></li>
              <li><span class="text-gray-700 font-normal">Sea contrario al honor, a la intimidad personal y familiar o a la propia imagen de las personas.</span></li>
              <li><span class="text-gray-700 font-normal">Constituya cualquier tipo de publicidad.</span></li>
              <li><span class="text-gray-700 font-normal">Incluya cualquier tipo de virus o programa que impida el normal funcionamiento del Sitio Web.</span></li>
            </ul>
        </ul>
        <p>Si para acceder a algunos de los servicios y/o contenidos del Sitio Web, se le proporcionara una contraseña, se obliga a usarla de manera diligente, manteniéndola en todo momento en secreto. En consecuencia, será responsable de su adecuada custodia y confidencialidad, comprometiéndose a no cederla a terceros, de manera temporal o permanente, ni a permitir el acceso a los mencionados servicios y/o contenidos por parte de personas ajenas.</p>
        <p>Igualmente, se obliga a notificar a la EMPRESA cualquier hecho que pueda suponer un uso indebido de su contraseña, como, a título enunciativo, su robo, extravío o el acceso no autorizado, con el fin de proceder a su inmediata cancelación. En consecuencia, mientras no efectúe la notificación anterior, la EMPRESA quedará eximida de cualquier responsabilidad que pudiera derivarse del uso indebido de su contraseña, siendo de su responsabilidad cualquier utilización ilícita de los contenidos y/o servicios del Sitio Web por cualquier tercero ilegítimo.</p>
    ...
    <section class="container mx-auto px-6 mb-16 max-w-6xl">
      ...
      <div class="space-y-4 text-gray-700">
        ...
        <p>La EMPRESA no se hace responsable de las decisiones que pudieran adoptarse como consecuencia del acceso a los contenidos o informaciones ofrecidas, por cuanto dichas decisiones son tomadas por el usuario en el libre ejercicio de su voluntad.</p>
        <p>La EMPRESA podrá interrumpir el servicio o resolver de modo inmediato la relación con el Usuario si detecta que un uso de su Sitio Web o de cualquiera de los servicios ofertados en el mismo son contrarios a las presentes Condiciones Generales de Uso.</p>
        <p>La EMPRESA no se hace responsable por daños, perjuicios, pérdidas, reclamaciones o gastos derivados de las decisiones tomadas por el propio usuario en el libre uso de su voluntad durante su visita al Sitio Web, salvo que dichos daños, perjuicios, pérdidas, reclamaciones o gastos sean imputables directamente a la EMPRESA por fallos en la página, error u omisión.</p>
        <p>Únicamente será responsable de eliminar, lo antes posible, los contenidos que puedan generar tales perjuicios, siempre que así se notifique. En especial no será responsable de los perjuicios que se pudieran derivar, entre otros, de:</p>
        <ul class="list-disc list-inside space-y-2 ml-4 text-[#010cf7] font-medium">
          <li><span class="text-gray-700 font-normal">interferencias, interrupciones, fallos, omisiones, averías telefónicas, retrasos, bloqueos o desconexiones en el funcionamiento del sistema electrónico, motivadas por deficiencias, sobrecargas y errores en las líneas y redes de telecomunicaciones, o por cualquier otra causa ajena al control de la EMPRESA</span></li>
          <li><span class="text-gray-700 font-normal">intromisiones ilegítimas mediante el uso de programas malignos de cualquier tipo y a través de cualquier medio de comunicación, tales como virus informáticos o cualesquiera otros.</span></li>
          <li><span class="text-gray-700 font-normal">abuso indebido o inadecuado del Sitio Web</span></li>
          <li><span class="text-gray-700 font-normal">errores de seguridad o navegación producidos por un mal funcionamiento del navegador o por el uso de versiones no actualizadas del mismo. Los administradores de la EMPRESA se reservan el derecho de retirar, total o parcialmente, cualquier contenido o información presente en el Sitio Web</span></li>
        </ul>
    ...
    <section class="container mx-auto px-6 mb-16 max-w-6xl">
      ...
      <div class="space-y-4 text-gray-700">
        ...
        <ul class="list-disc list-inside space-y-2 ml-4 text-[#010cf7] font-medium">
          <li><span class="text-gray-700 font-normal">no podrán dar a entender que la EMPRESA recomienda ese sitio web o sus servicios o productos</span></li>
          <li><span class="text-gray-700 font-normal">no podrán falsear su relación con la EMPRESA ni afirmar que la EMPRESA ha autorizado tal enlace, ni incluir marcas, denominaciones, nombres comerciales, logotipos u otros signos distintivos de la EMPRESA</span></li>
          <li><span class="text-gray-700 font-normal">no podrán incluir contenidos que puedan considerarse de mal gusto, obscenos, ofensivos, controvertidos, que inciten a la violencia o la discriminación por razón de sexo, raza o religión, contrarios al orden público o ilícitos;</span></li>
          <li><span class="text-gray-700 font-normal">no podrán enlazar a ninguna página del Sitio Web distinta de la página principal; (v) deberá enlazar con la propia dirección del Sitio Web, sin permitir que el sitio web que realice el enlace reproduzca el Sitio Web como parte de su web o dentro de uno de sus “frames” o crear un “browser” sobre cualquiera de las páginas del Sitio Web.</span></li>
        </ul>
