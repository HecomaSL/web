  ...
  <MainLayout>
    ...
    <section class="container mx-auto px-6 mb-16">
      <div class="max-w-6xl mx-auto space-y-6 text-gray-700 leading-relaxed text-lg">
        <p>Seleccionar la herramienta adecuada es la diferencia entre un acabado profesional y un panel astillado. En el mercado existen diversas opciones, pero para acertar con las fresas para ranurar, debemos fijarnos en la composición del material y el tipo de máquina que utilizaremos.</p>
        <h2 class="text-[#010cf7] text-3xl font-bold mb-6">1. Analiza el número de dientes (Z)</h2>
        <p>El número de dientes determina la velocidad de avance y la limpieza del corte. Dependiendo de tu producción, estas son las opciones líderes:</p>
        ...
        <h2 class="text-[#010cf7] text-3xl font-bold mb-6">2. ¿Necesitas precortadores? (El sistema Z+V)</h2>
        <p>Si trabajas con materiales delicados como la melamina o el contrachapado, las fresas para ranurar estándar pueden astillar los bordes. Para evitarlo, la ingeniería de HECOMA propone el sistema de precortadores:</p>
        <div class="flex flex-col md:flex-row gap-6 w-full ">
          <div class="flex-1 bg-white border border-gray-100 rounded-xl shadow-sm p-6 md:p-8 custom-card">
        ...
        <h2 class="text-[#010cf7] text-3xl font-bold mb-6">3. Versatilidad: ¿Fija o Extensible?</h2>
        <p>Optimiza tu inversión considerando la frecuencia con la que cambias de espesor de tablero en tus proyectos:</p>
          ...
          <table class="w-full border-collapse bg-white table-fixed">
            <thead>
              <tr class="bg-[#003399] text-white">
                <th class="w-[33%] text-center">Tipo de Fresa para Ranurar</th>
            ...
            <tbody class="text-gray-600">
              <tr class="hover:bg-gray-50 transition-colors">
                <td class="font-bold text-[#003399]">Fresas para Ranurar Fijas</td>
                <td class="text-justify text-gray-500">Estabilidad máxima en medidas estándar.</td>
        ...
        <h2 class="text-[#010cf7] text-3xl font-bold mb-6">4. Datos técnicos y seguridad</h2>
        <p>Antes de montar tus fresas para ranurar, verifica siempre las especificaciones grabadas en el cuerpo de la herramienta. Factores como el RPM máximo y el tipo de alimentación (MEC para avance mecánico) son críticos para el correcto desempeño de la herramienta.</p>
        <div class="flex flex-col md:flex-row gap-6 w-full ">
          <div class="flex-1 bg-white border border-gray-100 rounded-xl shadow-sm p-6 md:p-8 custom-card">
            <h3 class="text-[#003399] text-2xl md:text-2xl font-semibold text-center mb-4">Mejora tu producción hoy mismo</h3>
            <p class="bf text-gray-600 text-l md:text-base text-justify leading-relaxed">Contamos con el stock más completo de fresas para ranurar de alta precisión para carpintería industrial.</p>
            <div class="flex justify-center">
              <button type="button" onclick="window.location.href='/fresas'" class="btn-mdi-dark">Compre online ahora</button>
            </div>
          </div>
        </div>
      </div>
