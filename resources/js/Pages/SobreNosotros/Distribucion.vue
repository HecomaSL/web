  ...
  <MainLayout>
    <section class="bg-[#010cf7] py-6 mb-5">
      <div id="divh1" class="container mx-auto px-6">
        <h1 class="text-white text-3xl md:text-4xl font-bold text-center uppercase tracking-wide">Distribución y Logística de Herramientas de Corte</h1>
        <p class="text-white font-bold ">Únete a nuestra red. Únete a nuestro plan de éxito. Juntos somos mas fuertes.</p>
      </div>
    </section>
    ...
    <section class="container mx-auto px-6 mb-6">
      <div class="max-w-6xl mx-auto space-y-6 text-gray-700 leading-relaxed text-lg">
        ...
        <p>Si eres un profesional del suministro industrial y buscas expandir tu catálogo con soluciones de alto rendimiento para el <b>sector de la madera</b>, en HECOMA te ofrecemos una oportunidad de crecimiento estratégica. Buscamos establecer alianzas con distribuidores que deseen comercializar herramientas de fabricación propia con el sello de calidad de nuestras plantas en Toledo y Córdoba.</p>
        <p>Al unirte a nuestra red oficial, no solo obtendrás acceso a un stock preferente de <b>sierras circulares, fresas de diamante (PCD) y metal duro (HM)</b>, sino que contarás con el respaldo de nuestro departamento de ingeniería para el diseño de herramientas especiales a medida. Ofrecemos condiciones competitivas, formación técnica continua y una logística proactiva diseñada para que tus clientes nunca detengan su producción. Crezcamos juntos aportando valor real a la industria, con la garantía de un <b>fabricante líder en España</b> y un equipo cercano que te acompaña en cada cierre de venta.</p>
      </div>
    </section>
    ...
    <section class="container mx-auto px-6 mb-10">
      <div class="max-w-6xl mx-auto space-y-6 text-gray-700 leading-relaxed text-lg">
        ...
        <div class="space-y-4 text-gray-700">
          <p>HECOMA® <b>es una marca consolidada en el sector</b> de la herramienta para madera y derivados, a nivel nacional y europeo. Nuestros <b>productos y servicios</b> son <b>apreciados y demandados</b> por los clientes por su variedad, calidad y adaptación a sus necesidades.</p>
          <p>Apreciamos el valor de un buen profesional, y por eso queremos contar contigo en nuestro proyecto. Con nuestra ayuda <b>puedes fidelizar a tus clientes</b>, ofreciendo mayor variedad de productos y servicios. Te facilitamos la posibilidad de entrar en nuevos clientes, aquellos que por volumen, por variedad, o por tipo de demanda, hasta ahora, no podías entrar.</p>
        </div>
      </div>
    </section>
