...
<head>
    ...
    <style>
        ...
        .header { background-color: #0000BB; color: #ffffff; padding: 20px; text-align: center; }
        .header h1 { margin: 0; font-size: 20px; text-transform: uppercase; }
        .content { padding: 30px; }
        .field { margin-bottom: 20px; }
        .label { font-weight: bold; color: #0000BB; display: block; margin-bottom: 5px; text-transform: uppercase; font-size: 12px; }
        .value { font-size: 16px; background-color: #f9f9f9; padding: 10px; border-radius: 4px; border-left: 4px solid #0000BB; }
