...
// Ruta afilado
Route::get('/afilado', function () { return Inertia::render('Servicios/Afilado'); })->name('afilado');
Route::get('/servicios', function () { return Inertia::render('Servicios/Servicios'); })->name('servicios');
Route::get('/afilado-para-madera', function () { return Inertia::render('Servicios/Afilado/AfiladoParaMadera'); })->name('afilado-para-madera');
Route::get('/afilado-para-diamante', function () { return Inertia::render('Servicios/Afilado/AfiladoParaDiamante'); })->name('afilado-para-diamante');
...
Route::get('/politica-privacidad', function () { return Inertia::render('TextosLegales/PoliticaPrivacidad'); })->name('politica-privacidad');
Route::get('/politica-cookies', function () { return Inertia::render('TextosLegales/PoliticaCookies'); })->name('politica-cookies');
Route::get('/politica-proteccion-datos', function () { return Inertia::render('TextosLegales/PoliticaProteccionDatos'); })->name('politica-proteccion-datos');
Route::get('/noticias', function () { return Inertia::render('SobreNosotros/Noticias'); })->name('noticias');
