...
class DiscosController extends Controller {
    ...
    public function showSerie2_4() {
        $productos = Producto::where('familia', 'Serie 2.4')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/aplicaciones-especiales/discos-finos-para-maderas-de-calidad', [ 'products' => $productos ]);
    }
    public function showSerie2_5() {
        $productos = Producto::where('familia', 'Serie 2.5')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/aplicaciones-especiales/discos-muy-finos-con-cuerpo-de-alta-tenacidad', [ 'products' => $productos ]);
    }
    ...
    public function showSerie3_5() {
        $productos = Producto::where('familia', 'Serie 3.5')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/incisores/incisores-para-canteadoras', [ 'products' => $productos ]);
    }
    ...
    public function showSerie6_1() {
        $productos = Producto::where('familia', 'Serie 6.1')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/maquina-portatil/maquina-portatil', [ 'products' => $productos ]);
    }
    public function showSerie7_1() {
        $productos = Producto::where('familia', 'Serie 7.1')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/discos-materiales-no-ferrosos/discos-materiales-no-ferrosos', [ 'products' => $productos ]);
    }
    public function showSerie8_1() {
        $productos = Producto::where('familia', 'Serie 8.1')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/discos-materiales-ferrosos/discos-materiales-ferrosos', [ 'products' => $productos ]);
    }
    public function showSerie9_1() {
        $productos = Producto::where('familia', 'Serie 9.1')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/madera-maciza/sin-limitador-de-viruta', [ 'products' => $productos ]);
    }
    public function showSerie9_2() {
        $productos = Producto::where('familia', 'Serie 9.2')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/madera-maciza/con-limitador-de-viruta', [ 'products' => $productos ]);
    }
    public function showSerie10_1() {
        $productos = Producto::where('familia', 'Serie 10.1')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/sierra-multiple/sin-limitador', [ 'products' => $productos ]);
    }
    ...
    public function showSerie11_3() {
        $productos = Producto::where('familia', 'Serie 11.3')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/discos-silenciosos/discos_silenciados_seccionadora_laminados', [ 'products' => $productos ]);
    }
    public function showSerie11_4() {
        $productos = Producto::where('familia', 'Serie 11.4')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/discos-silenciosos/discos_silenciados_aluminio', [ 'products' => $productos ]);
    }
    public function showSerie11_5() {
        $productos = Producto::where('familia', 'Serie 11.5')->orderBy('referencia', 'asc')->get();
        return Inertia::render('Catalogo/Discos/discos-silenciosos/discos_silenciados_recubrimiento', [ 'products' => $productos ]);
    }
}